...
Creating One VM with script 

https://github.com/Shiwankar-Mrunal/System-Administration-using-Linux/blob/main/VM-script

Step 2 : Create sub for manually 

Step 3 : run following script in sub vm to fetch vm data for monitoring
